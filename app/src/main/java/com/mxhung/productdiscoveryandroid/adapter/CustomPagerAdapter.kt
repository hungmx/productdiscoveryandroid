...
import com.mxhung.productdiscoveryandroid.databinding.ItemListImageBinding
...
class CustomPagerAdapter(val context: Context, val images: IntArray) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        val binding = ItemListImageBinding.inflate(LayoutInflater.from(context), container, false)
